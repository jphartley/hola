pipeline {
 ...
 parameters {
     ...
     //gitParameter(name: 'PULL_NUMBER', type: 'PT_PULL_REQUEST', defaultValue: '-1', sortMode: 'DESCENDING_SMART')
 }
 ...
 stages {
   ...
   stage('Build') {
         steps {
           sh "pack build hferentschik/hello --builder paketobuildpacks/builder:tiny --publish"
         }
   }  
 }
}
